...
export const getSubscribeToEventUrl = () => {
  ...
  return `https://db-dev-stage.vercel.app/subscriptions`
}
...
export const getAccessInviteLinkUrl = (subscriberId: string,) => {
  ...
  return `https://db-dev-stage.vercel.app/invites/${subscriberId}`
}
...
export const getGetRankingUrl = () => {
  ...
  return `https://db-dev-stage.vercel.app/ranking`
}
...
export const getGetSubscriberInviteCountUrl = (subscriberId: string,) => {
  ...
  return `https://db-dev-stage.vercel.app/subscribers/${subscriberId}/ranking/count`
}
...
export const getGetSubscriberInviteClicksUrl = (subscriberId: string,) => {
  ...
  return `https://db-dev-stage.vercel.app/subscribers/${subscriberId}/ranking/clicks`
}
...
export const getGetSubscriberRankingPositionUrl = (subscriberId: string,) => {
  ...
  return `https://db-dev-stage.vercel.app/subscribers/${subscriberId}/ranking/position`
}
